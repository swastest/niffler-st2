...
public interface AuthService {
    ...
    /*
    1 запрос
GET http://127.0.0.1:9000/register
Referer: http://127.0.0.1:3000/
        ответ 1 запрос
        200
        X-Xsrf-Token:e51e353d-817b-43b4-b8cc-a3cd5ae825ca
        Set-Cookie:XSRF-TOKEN=e51e353d-817b-43b4-b8cc-a3cd5ae825ca; Path=/

      2 запрос
POST http://127.0.0.1:9000/register
Cookie: XSRF-TOKEN=e51e353d-817b-43b4-b8cc-a3cd5ae825ca
form data
_csrf: 97f2742a-942a-41d5-9088-8eadff0fbf04
username: popo2
password: popo2
passwordSubmit: popo2
        ответ 2 запрос
        201  X-Xsrf-Token: e51e353d-817b-43b4-b8cc-a3cd5ae825ca
